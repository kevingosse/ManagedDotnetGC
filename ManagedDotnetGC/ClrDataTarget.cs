...
namespace ManagedDotnetGC
{
    ...
    {
        private readonly NativeStubs.ICLRDataTargetStub _clrDataTargetStub;

        public ClrDataTarget()
        {
            _clrDataTargetStub = NativeStubs.ICLRDataTargetStub.Wrap(this);
        }
        ...
        {
            Console.WriteLine("ClrDataTarget - QueryInterface - " + guid);

            if (guid == KnownGuids.IClrDataTarget2)
            {
                Console.WriteLine("IClrDataTarget2");
        ...
        {
            Console.WriteLine("ClrDataTarget - GetMachineType");
        ...
        {
            Console.WriteLine("ClrDataTarget - GetPointerSize");
        ...
        public HResult GetImageBase(char* moduleName, out CLRDATA_ADDRESS baseAddress)
        {
            ...
            Console.WriteLine("ClrDataTarget - GetImageBase - " + name);
        ...
        {
            // Console.WriteLine("ClrDataTarget - ReadVirtual - " + address);
        ...
        {
            Console.WriteLine("ClrDataTarget - WriteVirtual");
            done = default;
            return HResult.E_NOTIMPL;
        }
        ...
        {
            Console.WriteLine("ClrDataTarget - GetTLSValue");
            value = default;
            return HResult.E_NOTIMPL;
        }
        ...
        {
            Console.WriteLine("ClrDataTarget - SetTLSValue");
            return HResult.E_NOTIMPL;
        }
